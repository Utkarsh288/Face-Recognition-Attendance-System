...
class Developer:
    def __init__(self,root):
        ...
        img_top1=Image.open(r"Images\wp6811963.webp")
        ...
        # Developer Info
        dev_lablel=Label(main_frame,text="I am a Coder:",font=("Times New Roman",17,"bold"),bg="White")
        dev_lablel.grid(row=0,column=0,padx=3)

        dev_lablel=Label(main_frame,text="This is my Project",font=("Times New Roman",17,"bold"),bg="White")
        dev_lablel.grid(row=1,column=0,padx=3)
